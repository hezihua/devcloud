...
type User struct {
	...
	Meta *meta.Meta `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta"`
...
type CreateUserRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty" bson:"username" validate:"required"`
	// @gotags: bson:"password" json: "password" validate:"required"
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" bson:"password" validate:"required"`
}
...
var file_apps_user_pb_user_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x63, 0x22, 0x4b, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x42, 0x20, 0x5a, 0x1e, 0x68, 0x7a, 0x68, 0x2f, 0x64, 0x65, 0x76, 0x63, 0x6c, 0x6f, 0x75, 0x64,
